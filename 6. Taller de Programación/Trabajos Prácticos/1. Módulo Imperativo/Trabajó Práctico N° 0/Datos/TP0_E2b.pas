...
procedure buscar_codigos_propiedades(vector_propiedades: t_vector_propiedades; zona: t_zonas; tipo: t_tipos);
var
  i: int16;
begin
  i:=1;
  ...
  begin
    textcolor(green); write('El código de la propiedad '); textcolor(red); write(i); textcolor(green); write(' es '); textcolor(red); writeln(vector_propiedades[zona]^.ele.codigo);
...
begin
  ...
  textcolor(yellow); readln(zona);
  textcolor(green); write('Introducir tipo de propiedad que se desea buscar (1: Casa, 2: Departamento, 3: Lote): ');
